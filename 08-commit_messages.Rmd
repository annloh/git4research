...
If you, for example, decide to use a different estimator and therefore have to change a lot of code that could still be a coherent set of changes. "Use estimator abc instead of estimator xyz".
